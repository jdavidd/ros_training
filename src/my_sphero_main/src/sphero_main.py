...
from my_sphero_main.msg import exam_action_rec_odomGoal, exam_action_rec_odomFeedback, exam_action_rec_odomResult, exam_action_rec_odomAction
from move_sphero import MoveSphero
...
class ControlSphero(object):
    ...
    def init_rec_odom_action_client(self):
        self._rec_odom_action_client = actionlib.SimpleActionClient('/record_odom', exam_action_rec_odomAction)
        # waits until the action server is up and running
        rospy.loginfo('Waiting for action Server')
        self._rec_odom_action_client.wait_for_server()
        rospy.loginfo('Action Server Found...')
        self._rec_odom_action_goal = exam_action_rec_odomGoal()
    ...
    def init_move_sphero_publisher(self):
        self._cmdvelpub_object = MoveSphero()

    def move_sphero(self, direction):
        self._cmdvelpub_object.move_sphero(direction)
